...
function Grid(gridNode) {
  ...
  'showKeysIndicator', 'hideKeysIndicator'].forEach((method) => {
 ...
 *  Keydown event
 */
Grid.prototype.focusClickedCell = function({target}) {
 ...
 *  Keydown event
 */
Grid.prototype.delegateButtonHandler = function (event) {
  const key = event.which || event.keyCode;
 ...
 */
Grid.prototype.toggleEditMode = function (editCell, toggleOn, updateText) {
 ...
 *  Header DOM node
 */
Grid.prototype.handleSort = function (headerNode) {
 ...
 */
Grid.prototype.sortRows = function (compareFn) {
 ...
 */
Grid.prototype.setupIndices = function () {
  const rows = this.gridNode.querySelectorAll(aria.GridSelector.ROW);
 ...
 *  accordingly.
 */
Grid.prototype.setupPagination = function () {
...
Grid.prototype.setPaginationChangeHandler = function (onPaginationChange) {
 ...
 *  Keydown event
 */
Grid.prototype.checkPageChange = function (event) {
  if (!event) {
    return;
  }
...
Grid.prototype.movePageUp = function () {
...
Grid.prototype.movePageDown = function () {
 ...
 */
Grid.prototype.showFromRow = function (startIndex, scrollDown) {
  const dataRows =
 ...
 */
Grid.prototype.checkRestructureGrid = function () {
 ...
 */
Grid.prototype.restructureGrid = function () {
 ...
 *  Index of the column to toggle
 */
Grid.prototype.findClosest = (element, selector) => {
...
export const AriaGridBehavior = Grid;
